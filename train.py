...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-size",
                        choices=["xsmall", "small", "medium", "large"], type=str,
    ...
    if args.model_size == "xsmall":  # 6.3M non embedding parameters
        n_layers = 12
        width = 256
        n_heads = 4
    elif args.model_size == "small":  # 21.3M non embedding parameters
        n_layers = 18
        width = 384
        n_heads = 6
    elif args.model_size == "medium":  # 50.4M non embedding parameters
        n_layers = 24
        width = 512
        n_heads = 8
    elif args.model_size == "large":  # 141.8M non embedding parameters
        n_layers = 30
        width = 768
        n_heads = 12
    else:
